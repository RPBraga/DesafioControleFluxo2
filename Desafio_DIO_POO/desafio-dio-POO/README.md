...
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também serão MODELADAS, sendo criadas seus ATRIBUTOS E MÉTODOS <br> 
<strong>	4.</strong> Foram utilizadas ferramentoas de POO: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
